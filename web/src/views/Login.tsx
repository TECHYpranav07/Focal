...
import { Mail, KeyRound, ArrowRight, Sparkles, Image, ShieldCheck } from 'lucide-react';
      ...
      <div className="auth-form-side">
        ...
        <div style={styles.formCenterWrapper}>
          <GlassCard padding="xl" style={styles.card}>
            ...
            <p style={styles.cardSubtitle}>Unlock your personalized photo galleries instantly</p>
...
const styles = {
  ...
  brandSide: {
    ...
    backgroundImage: 'radial-gradient(circle at 30% 20%, #1e294b 0%, #0c1122 80%)',
